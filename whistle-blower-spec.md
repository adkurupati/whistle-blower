...
| 6 | Fan discussion ingestion (YouTube, confirmed — see Fan Discussion Sourcing) — **ingestion done 2026-08-22**; PyTorch triage classifier — **not started, weak-labeling done, training next** | 1.5 wks | Ingestion: `social_discussion` populated across 9 real games (5,400 rows), idempotent batch script, weak-labeling script confirming real signal (see Weak Labeling section). Classifier: pending |
